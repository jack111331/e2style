...
DATASETS = {
	'shhq_encode': {
		...
		'train_source_root': dataset_paths['shhq'],
		'train_target_root': dataset_paths['shhq'],
		'test_source_root': dataset_paths['shhq_test'],
		'test_target_root': dataset_paths['shhq_test'],
	},
	'ffhq_encode': {
		'transforms': transforms_config.EncodeTransforms,
